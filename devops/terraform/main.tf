...
# ============================================
# COMMENTED OUT: Azure Redis (Cost Optimization - Using Self-Hosted Redis on AKS)
# Uncomment to use Azure Redis Cache instead of self-hosted
# ============================================
# # ------------- Shared Redis -----------------------
...
module "monitoring" {
  ...
  redis_id                   = null # Using self-hosted Redis on AKS, no Azure Redis to monitor
  ...
  depends_on = [
    ...
    module.database,
    module.signalr,
    # module.redis,  # COMMENTED OUT: Using self-hosted Redis
    module.frontend
  ]
}
