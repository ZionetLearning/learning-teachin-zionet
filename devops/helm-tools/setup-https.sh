...
DOMAIN="teaching-zionet.westeurope.cloudapp.azure.com"
...
kubectl wait --for=condition=ready certificate teaching-zionet-tls -n $NAMESPACE --timeout=300s
...
echo "kubectl describe certificate teaching-zionet-tls -n $NAMESPACE"
