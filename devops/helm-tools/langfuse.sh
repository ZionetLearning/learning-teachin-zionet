...
helm $ACTION langfuse langfuse/langfuse \
  ...
  --set-string langfuse.additionalEnv[2].value="false" \
  ...
  --set-string langfuse.additionalEnv[24].value="https://teachin.westeurope.cloudapp.azure.com/langfuse" \
