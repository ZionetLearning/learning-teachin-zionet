...
helm $ACTION langfuse langfuse/langfuse \
  ...
  --set-string langfuse.additionalEnv[36].value="<div style=\"font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;\"><div style=\"background: #667eea; color: white; padding: 20px; text-align: center;\"><h1>Join {{organizationName}} on Langfuse</h1></div><div style=\"background: #f9f9f9; padding: 30px;\"><p>Hello,</p><p><strong>{{inviterName}}</strong> ({{inviterEmail}}) has invited you to join the <strong>{{organizationName}}</strong> organization on Langfuse.</p><div style=\"background: white; padding: 20px; border-left: 4px solid #667eea; margin: 20px 0;\"><p style=\"margin: 0; font-size: 14px; color: #666;\">You will be granted access to collaborate on LLM observability and monitoring.</p></div><p style=\"text-align: center;\"><a href=\"{{url}}\" style=\"background: #667eea; color: white; padding: 12px 24px; text-decoration: none; border-radius: 5px; display: inline-block; font-weight: bold;\">Accept Invitation</a></p><p style=\"font-size: 13px; color: #666; text-align: center;\"><em>(sign in with your existing account)</em></p><p style=\"font-size: 12px; color: #999; margin-top: 30px;\">Or copy and paste this URL into your browser:</p><p style=\"font-size: 12px; background: #f4f4f4; padding: 10px; word-break: break-all;\">{{url}}</p><hr style=\"border: none; border-top: 1px solid #ddd; margin: 20px 0;\"/><p style=\"font-size: 11px; color: #999;\">This invitation was intended for {{inviteeEmail}}. If you were not expecting this invitation, you can ignore this email.</p></div></div>" \
