...
helm $ACTION langfuse langfuse/langfuse \
  ...
  --set-string langfuse.additionalEnv[14].value="false" \
  --set langfuse.additionalEnv[15].name="SMTP_TLS" \
  --set-string langfuse.additionalEnv[15].value="true" \
  --set langfuse.additionalEnv[16].name="SMTP_REQUIRE_TLS" \
  --set-string langfuse.additionalEnv[16].value="true" \
  --set langfuse.additionalEnv[17].name="SMTP_AUTH_METHOD" \
  --set-string langfuse.additionalEnv[17].value="LOGIN" \
  --set langfuse.additionalEnv[18].name="SMTP_FROM_NAME" \
  --set-string langfuse.additionalEnv[18].value="TeachIn" \
  --set langfuse.additionalEnv[19].name="SMTP_FROM_EMAIL" \
