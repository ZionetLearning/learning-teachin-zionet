...
helm $ACTION langfuse langfuse/langfuse \
  ...
  --set-string langfuse.additionalEnv[29].value="You're invited to join TeachIn's Langfuse" \
  --set langfuse.additionalEnv[30].name="MEMBERSHIP_INVITATION_EMAIL_TEMPLATE" \
  --set-string langfuse.additionalEnv[30].value="You have been invited to join TeachIn's Langfuse instance. Click the link below to accept the invitation." \
