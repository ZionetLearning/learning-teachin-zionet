...
helm $ACTION langfuse langfuse/langfuse \
  ...
  --set langfuse.additionalEnv[14].name="INVITE_FROM_EMAIL" \
  --set-string langfuse.additionalEnv[14].value="$SMTP_USER" \
  --set langfuse.additionalEnv[15].name="INVITE_FROM_NAME" \
  --set-string langfuse.additionalEnv[15].value="TeachIn Admin" \
  --set langfuse.additionalEnv[16].name="SMTP_SECURE" \
  --set-string langfuse.additionalEnv[16].value="true" \
  --set langfuse.additionalEnv[17].name="SMTP_TLS" \
  --set-string langfuse.additionalEnv[17].value="true" \
  --set langfuse.additionalEnv[18].name="SMTP_AUTH_METHOD" \
  --set-string langfuse.additionalEnv[18].value="LOGIN" \
  --set langfuse.additionalEnv[19].name="SMTP_FROM_NAME" \
