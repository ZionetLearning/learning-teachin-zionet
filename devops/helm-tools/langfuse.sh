...
helm $ACTION langfuse langfuse/langfuse \
  ...
  --set-string langfuse.additionalEnv[11].value="465" \
  ...
  --set langfuse.additionalEnv[14].name="SMTP_SECURE" \
  --set-string langfuse.additionalEnv[14].value="true" \
  --set langfuse.additionalEnv[15].name="SMTP_FROM" \
  --set-string langfuse.additionalEnv[15].value="$SMTP_USER" \
  --set langfuse.additionalEnv[16].name="AUTH_SMTP_USER" \
  --set-string langfuse.additionalEnv[16].value="$SMTP_USER" \
  --set langfuse.additionalEnv[17].name="AUTH_SMTP_PASS" \
  --set-string langfuse.additionalEnv[17].value="$SMTP_PASSWORD" \
  --set langfuse.additionalEnv[18].name="SMTP_DEBUG" \
  --set-string langfuse.additionalEnv[18].value="true" \
  --set langfuse.additionalEnv[19].name="SMTP_LOG_LEVEL" \
  --set-string langfuse.additionalEnv[19].value="debug" \
  --set langfuse.additionalEnv[20].name="SMTP_LOGGER" \
  --set-string langfuse.additionalEnv[20].value="true" \
  --set langfuse.additionalEnv[21].name="NEXT_PUBLIC_INVITE_URL" \
  --set-string langfuse.additionalEnv[21].value="https://teachin.westeurope.cloudapp.azure.com/langfuse" \
  --set langfuse.additionalEnv[22].name="NEXTAUTH_INVITATION_EMAIL_SUBJECT" \
  --set-string langfuse.additionalEnv[22].value="You have been invited to TeachIn's Langfuse" \
  --set langfuse.additionalEnv[23].name="NEXTAUTH_INVITATION_EMAIL_TEMPLATE" \
  --set-string langfuse.additionalEnv[23].value="<p>You have been invited to join TeachIn's Langfuse instance.</p><p>Click the button below to accept the invitation:</p>" \
  --set langfuse.additionalEnv[24].name="INVITE_FROM_NAME" \
  --set-string langfuse.additionalEnv[24].value="TeachIn Admin" \
  --set langfuse.additionalEnv[25].name="INVITE_FROM_EMAIL" \
  --set-string langfuse.additionalEnv[25].value="$SMTP_USER" \
  --set langfuse.additionalEnv[26].name="NEXT_PUBLIC_CONTACT_EMAIL" \
  --set-string langfuse.additionalEnv[26].value="$SMTP_USER" \
  --set langfuse.additionalEnv[27].name="EMAIL_FROM_NAME" \
  --set-string langfuse.additionalEnv[27].value="TeachIn" \
  --set langfuse.additionalEnv[28].name="EMAIL_FROM_ADDRESS" \
  --set-string langfuse.additionalEnv[28].value="$SMTP_USER" \
  --set langfuse.additionalEnv[29].name="EMAIL_FROM" \
  --set-string langfuse.additionalEnv[29].value="$SMTP_USER" \
  --set langfuse.additionalEnv[30].name="MEMBERSHIP_INVITATION_EMAIL_SUBJECT" \
  --set-string langfuse.additionalEnv[30].value="You're invited to join TeachIn's Langfuse" \
  --set langfuse.additionalEnv[31].name="MEMBERSHIP_INVITATION_EMAIL_TEMPLATE" \
  --set-string langfuse.additionalEnv[31].value="You have been invited to join TeachIn's Langfuse instance. Click the link below to accept the invitation." \
  --set langfuse.additionalEnv[32].name="INVITE_URL_BASE" \
  --set-string langfuse.additionalEnv[32].value="https://teachin.westeurope.cloudapp.azure.com/langfuse" \
  --set redis.auth.existingSecret="langfuse-secrets" \
  --set redis.auth.existingSecretPasswordKey="REDIS_PASSWORD" \
