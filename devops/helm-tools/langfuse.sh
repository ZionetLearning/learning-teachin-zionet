...
helm $ACTION langfuse langfuse/langfuse \
  ...
  --set langfuse.additionalEnv[10].name="SMTP_CONNECTION_URL" \
  --set-string langfuse.additionalEnv[10].value="smtps://$SMTP_USER:$SMTP_PASSWORD@smtp.gmail.com:465" \
  ...
  --set langfuse.additionalEnv[14].name="SMTP_PASSWORD" \
  --set-string langfuse.additionalEnv[14].value="$SMTP_PASSWORD" \
  --set langfuse.additionalEnv[15].name="SMTP_SECURE" \
  --set-string langfuse.additionalEnv[15].value="true" \
  --set langfuse.additionalEnv[16].name="SMTP_FROM" \
  --set-string langfuse.additionalEnv[16].value="$SMTP_USER" \
  --set langfuse.additionalEnv[17].name="AUTH_SMTP_USER" \
  ...
  --set-string langfuse.additionalEnv[22].value="https://teachin.westeurope.cloudapp.azure.com/langfuse" \
  --set langfuse.additionalEnv[23].name="NEXTAUTH_INVITATION_EMAIL_SUBJECT" \
  --set-string langfuse.additionalEnv[23].value="You have been invited to TeachIn's Langfuse" \
  --set langfuse.additionalEnv[24].name="NEXTAUTH_INVITATION_EMAIL_TEMPLATE" \
  --set-string langfuse.additionalEnv[24].value="<p>You have been invited to join TeachIn's Langfuse instance.</p><p>Click the button below to accept the invitation:</p>" \
  --set langfuse.additionalEnv[25].name="INVITE_FROM_NAME" \
  --set-string langfuse.additionalEnv[25].value="TeachIn Admin" \
  --set langfuse.additionalEnv[26].name="INVITE_FROM_EMAIL" \
  --set-string langfuse.additionalEnv[26].value="$SMTP_USER" \
  --set langfuse.additionalEnv[27].name="NEXT_PUBLIC_CONTACT_EMAIL" \
  --set-string langfuse.additionalEnv[27].value="$SMTP_USER" \
  --set langfuse.additionalEnv[28].name="EMAIL_FROM_NAME" \
  --set-string langfuse.additionalEnv[28].value="TeachIn" \
  --set langfuse.additionalEnv[29].name="EMAIL_FROM_ADDRESS" \
  ...
  --set langfuse.additionalEnv[35].name="AUTH_DISABLE_SIGNUP_DEFAULT_DOMAIN" \
  --set-string langfuse.additionalEnv[35].value="true" \
  --set langfuse.additionalEnv[36].name="INVITATION_REQUIRED" \
  --set-string langfuse.additionalEnv[36].value="true" \
  --set langfuse.additionalEnv[37].name="VALIDATE_INVITATION_EMAIL" \
