...
helm $ACTION langfuse langfuse/langfuse \
  ...
  --set langfuse.additionalEnv[22].name="NEXT_PUBLIC_CONTACT_EMAIL" \
  --set-string langfuse.additionalEnv[22].value="$SMTP_USER" \
  --set langfuse.additionalEnv[23].name="EMAIL_FROM_NAME" \
  --set-string langfuse.additionalEnv[23].value="TeachIn" \
  --set langfuse.additionalEnv[24].name="EMAIL_FROM_ADDRESS" \
  --set-string langfuse.additionalEnv[24].value="$SMTP_USER" \
  --set langfuse.additionalEnv[25].name="MEMBERSHIP_INVITATION_EMAIL_SUBJECT" \
  --set-string langfuse.additionalEnv[25].value="You're invited to join TeachIn's Langfuse" \
  --set langfuse.additionalEnv[26].name="MEMBERSHIP_INVITATION_EMAIL_TEMPLATE" \
  --set-string langfuse.additionalEnv[26].value="You have been invited to join TeachIn's Langfuse instance. Click the link below to accept the invitation." \
  --set langfuse.additionalEnv[27].name="INVITE_URL_BASE" \
  --set-string langfuse.additionalEnv[27].value="https://teachin.westeurope.cloudapp.azure.com/langfuse" \
  --set redis.auth.existingSecret="langfuse-secrets" \
  --set redis.auth.existingSecretPasswordKey="REDIS_PASSWORD" \
