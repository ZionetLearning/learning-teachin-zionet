...
public static class ManagerEndpoints
{
    ...
    {
        logger.LogInformation($"Inside {nameof(GetTaskAsync)}");
        try
        {
    ...
    private static async Task<IResult> CreateTaskAsync(
        ...
        [FromServices] ILogger<ManagerService> logger)
    {
        logger.LogInformation($"Inside {nameof(CreateTaskAsync)}");
        try
        {
    ...
    private static async Task<IResult> UpdateTaskNameAsync(
        ...
        [FromServices] ILogger<ManagerService> logger)
    {
        logger.LogInformation($"Inside {nameof(UpdateTaskNameAsync)}");
        try
        {
    ...
    private static async Task<IResult> DeleteTaskAsync(
        ...
        [FromServices] ILogger<ManagerService> logger)
    {
        logger.LogInformation($"Inside {nameof(DeleteTaskAsync)}");
        try
        {
