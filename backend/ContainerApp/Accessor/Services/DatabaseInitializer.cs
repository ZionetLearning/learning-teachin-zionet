...
public class DatabaseInitializer
{
    ...
    private async Task SeedAchievementsAsync()
    {
        ...
        var achievements = new List<Models.Achievements.AchievementModel>
        {
            ...
            // Word Order
            new() { AchievementId = Guid.NewGuid(), Key = "word_order_first", Name = "Sentence Builder", Description = "Complete your first word order game", Type = Models.Achievements.AchievementType.Milestone, Feature = Models.Achievements.PracticeFeature.WordOrder, TargetCount = 1, IsActive = true, CreatedAt = DateTime.UtcNow },
            new() { AchievementId = Guid.NewGuid(), Key = "word_order_3", Name = "Grammar Guru", Description = "Complete 3 word order games", Type = Models.Achievements.AchievementType.Count, Feature = Models.Achievements.PracticeFeature.WordOrder, TargetCount = 3, IsActive = true, CreatedAt = DateTime.UtcNow },
            new() { AchievementId = Guid.NewGuid(), Key = "word_order_5", Name = "Syntax Master", Description = "Complete 5 word order games", Type = Models.Achievements.AchievementType.Count, Feature = Models.Achievements.PracticeFeature.WordOrder, TargetCount = 5, IsActive = true, CreatedAt = DateTime.UtcNow },
