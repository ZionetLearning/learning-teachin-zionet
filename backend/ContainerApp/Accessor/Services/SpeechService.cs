...
public class SpeechService : ISpeechService
{
    ...
    {
        var region = _configuration["Speech:Region"] ?? _configuration["SPEECH_REGION"] ?? string.Empty;
        var key = _configuration["Speech:Key"] ?? _configuration["SPEECH_KEY"] ?? string.Empty;
