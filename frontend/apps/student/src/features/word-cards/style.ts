...
export const useStyles = createUseStyles({
  ...
  headerWrapper: (color: ColorTokens) => ({
    display: "flex",
    flexDirection: "column",
    alignItems: "center",
    textAlign: "center",
  ...
  addCardBtn: (color: ColorTokens) => ({
    ...
    "&[dir='rtl'] .MuiButton-startIcon": { marginLeft: 8, marginRight: 0 },
    "&[dir='rtl'] .MuiButton-endIcon": { marginRight: 8, marginLeft: 0 },
  }),
});
