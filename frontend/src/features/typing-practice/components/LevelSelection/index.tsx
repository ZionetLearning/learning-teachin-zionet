...
export const LevelSelection = ({ onLevelSelect, isLoading }: LevelSelectionProps) => {
    ...
    const getLevelInfo = (level: DifficultyLevel) => {
        switch (level) {
            ...
            default:
                return { icon: '🌱', label: 'Easy', description: 'Single Hebrew words' };
        }
    };
        ...
        <div className={classes.levelSelection}>
            <div>
                ...
                <p className={classes.levelDescription}>
                    Select a difficulty level to start practicing Hebrew typing.<br />
