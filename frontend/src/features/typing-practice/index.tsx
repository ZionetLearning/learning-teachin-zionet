...
export const TypingPractice = () => {
    ...
    const handleSubmitAnswer = () => {
        ...
        const feedbackResult = compareTexts(exerciseState.userInput, currentExercise.hebrewText);
    ...
    const handleNextExercise = () => {
        ...
        try {
            ...
            setExerciseState(prev => ({
                ...prev,
                error: error instanceof Error ? error.message : 'Failed to load next exercise',
            }));
        }
    };
    ...
    const renderExerciseArea = () => (
        <div className={classes.exerciseArea}>
            <div className={classes.exerciseHeader}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                    {exerciseState.selectedLevel && (
                        <span className={`${classes.levelBadge} ${getLevelBadgeClass(exerciseState.selectedLevel)}`}>
                            {exerciseState.selectedLevel}
                        </span>
                    )}
                    <button
            ...
            <div className={classes.audioSection}>
                <AudioControls
                    phase={exerciseState.phase as "ready" | "playing" | "typing" | "feedback"}
