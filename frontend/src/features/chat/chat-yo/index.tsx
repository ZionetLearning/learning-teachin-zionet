      ...
      <div className={classes.messagesList}>
        {messages.map((msg, i) => (
          <MessageBox
            ...
            type="text"
            text={msg.text}
            title={msg.position === "right" ? "Yonatan" : "Assistant"}
